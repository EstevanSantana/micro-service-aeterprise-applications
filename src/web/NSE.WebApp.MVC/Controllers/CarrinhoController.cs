...
namespace NSE.WebApp.MVC.Controllers
{
    ...
    public class CarrinhoController : MainController
    {
        ...
        public async Task<IActionResult> AdicionarItemCarrinho(ItemCarrinhoViewModel itemCarrinho)
        {
            ...
            itemCarrinho.Valor = produto.Preco;
        ...
        private void ValidarItemCarrinho(ProdutoViewModel produto, int quantidade)
        {
            ...
            if (quantidade > produto.QuantidadeEstoque) AdicionarErroValidacao($"O produto {produto.Nome} possui {produto.QuantidadeEstoque} unidade em estoque, você selecionou {quantidade}");
        }
    }
}
